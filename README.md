...
2.  **Sparse Shocks:** An replication of Lu and Shimizu (2025), implementing a different econometric approach to choice modeling, specifically focusing on sparse shocks and shrinkage estimators.
