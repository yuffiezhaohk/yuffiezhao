...
|------------------------|------------|----------------------------------------------|  
| `..`                   | Navigation | Parent directory link                        |  
| `bayesian_mcmc.py`     | Python Script | Bayesian MCMC sampling (posterior for prices, demand shocks η, cost shocks γ) |  
...
| `test.py`              | Python Script | Unit/integration test suite (moved & renamed) |  
...
| `testing plan & report.md`| File       | Validation strategy & execution log (renamed) |  
